'''
DT	Test Accuracy: 0.9905841685046886
DT (CV)	Test Accuracy: 0.9998709943753548
'''
import pandas as pd
...
dt_model.fit(X_train_words, np.asarray(y_train_syllables.argmax(axis=1)))

# Predict on the test set
y_pred = dt_model.predict(X_test_words)
